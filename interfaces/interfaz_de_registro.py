...
def presionar_boton_registrarse(var_usuario_nuevo, var_pass, var_pass_re, msg_final, usario_nuevo_entry, mi_clave_entry, mi_clave_re_entry):
    ...
    # tupla con tres booleanos validadores.
    es_valido = (jugador_valido(usuario_nuevo), pass_valida(contrasenia), (contrasenia == contrasenia_re))
    ...
    if es_valido[0] and es_valido[1] and es_valido[2]:
        # si es válido se guarda en el archivo de usuarios.
        guardar_usuario_nuevo(usuario_nuevo, contrasenia)
